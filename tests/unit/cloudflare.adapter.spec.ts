...
import { buildCloudflareProgressPayload, normalizeCloudflareWishRows, shouldUseCloudflareBackend } from '../../src/lib/cloudflare'
...
describe('cloudflare adapter', () => {
  ...
  it('builds a progress payload with the next current value', () => {
    expect(buildCloudflareProgressPayload({ wishId: 'wish-1', nextCurrent: 6, memberId: 'member-a', spaceId: 'space-1' })).toEqual({
      wishId: 'wish-1',
      nextCurrent: 6,
      memberId: 'member-a',
      spaceId: 'space-1',
